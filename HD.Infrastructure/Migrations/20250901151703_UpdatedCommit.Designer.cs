...
namespace HD.Infrastructure.Migrations
{
    ...
    [Migration("20250901151703_UpdatedCommit")]
    partial class UpdatedCommit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HD.ApplicationCore.Domain.Complaint", b =>
                {
                    ...
                    b.Property<DateTime>("ProcesseddDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HD.ApplicationCore.Domain.Admin", b =>
                {
                    b.HasOne("HD.ApplicationCore.Domain.Agent", null)
                        .WithOne()
                        .HasForeignKey("HD.ApplicationCore.Domain.Admin", "AgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
